/* 
  Datei: /datenschutz/page.jsx
  Version: 1.0.0
  Entwickler: Danny Nothdurft
  Beschreibung: Dieses Modul enthält den Datenschutz der Shop-Anwendung.
*/
...
function Datenschutz() {
  ...
  return (
    <div className="datenschutz--container">
      ...
      <p className="datenschutz--text--bold--center">
        {allSettings.host}
        <br />
        {allSettings.hostStreet}
        <br />
        {allSettings.hostCity}
      </p>
      ...
      <p className="datenschutz--text--bold--center">
        {allSettings.company}
        <br />
        {allSettings.street} {allSettings.streetNumber}
        <br />
        {allSettings.plz} {allSettings.city}
        <br />
        Telefon: {allSettings.tel}
        <br />
